...
echo "<input type='text' name='profile' size='20' value='' placeholder='Nama Profile'>  ";
echo "<input name='Submit' type='submit' value='Open' />  ";
echo "<input name='new' type='submit' value='New' />  ";
echo "<input name='update' type='submit' value='Save' /><br><br>  ";
echo "IP Rule:  <input type='text' name='ip_rule' size='22' value=''/>  ";
...
echo "<br><br>";
echo "<textarea name='payload' rows='4' cols='45' placeholder='Payload'></textarea>";
echo "<br><br>";
echo "<textarea name='text-info' rows='2' cols='45' placeholder='Info'></textarea>";
echo "
</form>
</div>";
include 'footer.php';
...
echo '  <input name="new" type="submit" value="New" />  ';
echo '<input name="update" type="submit" value="Save" /><br><br>';
echo "IP Rule:  <input type='text' name='ip_rule' size='22' value=\"$listx[1]\"/>";
if ($listx[0]=='yes'){
...
echo '<input type="checkbox" name="use_inject" value="yes" >Inject';}
echo '<br><br>';
echo "Proxy:  <input type='text' name='proxy' size='17' value=\"$listx[5]\"/>  ";
echo "Port:  <input type='text' name='port' size='6' value=\"$listx[6]\"/>";
echo "<br><br>";
echo 'Payload:<br>';
echo "<textarea name='payload' rows='4' cols='45'>$listx[7]</textarea>";
echo "<br><br>";
echo 'Info:<br>';
echo "<textarea name='text-info' rows='4' cols='45'>";
$x=0;
